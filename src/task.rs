...
// pub fn task<F:Fndecl<PR>,PR,C,R>(f:F)->(TaskCurrier<Currier<F,C,R>>,Option<usize>) {
//     (TaskCurrier {
...
//     }, None)
// }
// pub fn task_with<F:Fndecl<PR>,PR>(f:F,id:usize)->(F,Option<usize>) {
//     // (f,id)
//     todo!("task_with is not implemented yet")
// }
